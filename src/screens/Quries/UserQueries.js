...
const Screen1 = () => {
    ...
    // const handleanimate = () => {
    //     console.log("Navigating to Demo with demo parameter:", true);
    //     navigation.navigate('Demo', { ani: true });
    // };


    return (
        <View style={{ flex: 1 }}>
            {/* <TouchableOpacity style={{ backgroundColor: 'blue', height: 60, width: '60%', alignSelf: 'center' }} onPress={handleanimate}>
                <Text>Demo</Text>
            </TouchableOpacity> */}
