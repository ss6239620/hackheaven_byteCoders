...
export default function Header({ header, leftIconName, rightIconName, titleMargin, textColor, marginTop, children: Children, childrenStyle, isModal, setModalVisible, rightIconNavigate, onPressRightIcon }) {
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", height: 48, alignItems: 'center', marginTop: marginTop ? marginTop : 5, }}>
            ...
            {rightIconName
                ...
                <View style={{ width: 35, height: 35, backgroundColor: "white", justifyContent: "center", alignItems: "center", borderRadius: 50, borderWidth: 1, borderColor: colorTheme.borderColor }}>
                    <Ionicons name={rightIconName} size={25} color={colorTheme.primaryColor} onPress={() => { onPressRightIcon ? onPressRightIcon() : null }} />
                </View>
                :
                null
            }
